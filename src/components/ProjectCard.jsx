    ...
    <>
      ...
      {modalIsOpen && (
        <div
          ...
          ref={refModalOverlay}
        >
          <div className="w-[700px] h-auto  bg-black rounded-lg shadow-2xl flex flex-col items-center justify-center px-6 py-3 border border-neutral-600 shadow-slate-300">
            ...
            <div className="flex justify-center w-[700px]">
                ...
                {/* Button GitHub */}
                <div className="flex items-center justify-center mt-4 mr-[85%]  ">
                  <button className="group text-white flex border border-neutral-600 rounded-md px-4 py-2">
                ...
                <div className="flex mt-4">
                  {tag.map((item, index) => (
                    <p
                      key={index}
                      className="bg-neutral-600 text-white rounded-full px-2 py-1"
                    >
                      {item}
                    </p>
                  ))}
